      ...
      <div className="max-w-6xl mx-auto px-6 py-20 sm:py-24">
        <div className="max-w-2xl mb-8">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-3">
            Why{' '}
            <code className="font-mono text-2xl sm:text-3xl px-1.5 py-0.5 rounded bg-bg-subtle">
              required
            </code>{' '}
            appears twice.
          </h2>
          <p className="text-fg-muted text-lg">
            You may notice fields declare{' '}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
          <div className="p-5 rounded-lg bg-bg-subtle border border-border">
            ...
            <p className="text-sm text-fg-muted leading-relaxed">
              Will the form reject submission if this field is empty or
              malformed?
            </p>
          </div>
          <div className="p-5 rounded-lg bg-bg-subtle border border-border">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="text-left font-mono font-medium px-4 py-3">
                  yup
                </th>
                <th className="text-left font-mono font-medium px-4 py-3">
                  zod
            ...
            <tbody>
              {rows.map((row, i) => (
                ...
                >
                  <td className="font-medium px-4 py-3 text-fg-muted">
                    {row.label}
                  </td>
