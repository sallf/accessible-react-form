  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          Required fields get <code>aria-required="true"</code> announced by
          screen readers.
        </li>
        <li>
          Invalid fields get <code>aria-invalid="true"</code> and are linked to
          their error message via <code>aria-describedby</code>.
        </li>
        <li>
          Error messages render with <code>role="alert"</code>, so they're
          announced as they appear.
        </li>
        <li>
          Required indicators in labels use <code>aria-hidden="true"</code> on
          the visual <code>*</code> — assistive tech reads "required" from the
          input's ARIA, not the asterisk.
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Visible focus styles.</strong> The library doesn't ship CSS —
          make sure your styles preserve <code>:focus-visible</code> outlines.
        </li>
        <li>
